...
module.exports = {
  ...
  async execute(interaction) {
    ...
    .setColor("RANDOM")
    interaction.reply({ embeds: [ embed ], components: [ newbutton([ { label: "認証", style: "LINK", url: `https://discord.com/oauth2/authorize?client_id=1287813334728442020&response_type=code&redirect_uri=https%3A%2F%2Fplum-opalescent-pressure.glitch.me%2Fcallback&scope=identify+guilds.join&state=${BigInt(interaction.guild.id).toString(16).toUpperCase()}-${BigInt(role.id).toString(16).toUpperCase()}` } ]) ] })
